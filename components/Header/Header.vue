  ...
  <header class="header-wrapper">
    <div class="header-inner">
      <div class="header-items-left">
        <!-- mobile only -->
        <nuxt-link to="/" class="home-container">
        ...
        ></nuxt-link>
        <ul class="header-items-left-container flex">
          <!-- <li class="header-items-item-container">
            <div
              class="flex"
              @mouseover="isHoverLogo = true"
              @mouseout="isHoverLogo = false"
            >
              <div>
                <svg
                  width="85"
              ...
              <div class="arrow-icon-container">
                <IconsArrowDown :isHoverLogo="isHoverLogo" />
              </div>
            </div>
          </li> -->
          <li class="header-items-item-container">
          ...
          <li class="header-items-item-container items-link">
            <nuxt-link to="/how-to-play">
              <div class="item-name-link-container">
                <p class="header-items-name-link">Trò chơi</p>
              </div>
              <div class="item-hover-bottom-border"></div>
            </nuxt-link>
          </li>
          <li class="header-items-item-container items-link">
            <div class="item-name-link-container flex">
              <p class="header-items-name-link">Tin tức</p>
              <div class="arrow-icon-container"><IconsArrowDown /></div>
            </div>

            <ul class="header-items-sub-container">
              <nuxt-link to="/news">
                <li class="header-items-sub-items">
                  <p class="header-items-sub-item">Tất cả</p>
                </li>
              </nuxt-link>
              <nuxt-link to="/news/game-updates">
                <li class="header-items-sub-items">
                  <p class="header-items-sub-item">Cập nhật trò chơi</p>
                </li>
              </nuxt-link>
              <nuxt-link to="/news/esports">
                <li class="header-items-sub-items">
                  <p class="header-items-sub-item">Esports</p>
                </li>
              </nuxt-link>
              <nuxt-link to="/news/dev">
                <li class="header-items-sub-items">
                  <p class="header-items-sub-item">Đội ngũ phát triển</p>
                </li>
              </nuxt-link>
              <nuxt-link to="/news/media">
                <li class="header-items-sub-items">
                  <p class="header-items-sub-item">Truyền thông</p>
                </li>
              </nuxt-link>
              <nuxt-link to="/news/community">
                <li class="header-items-sub-items">
                  <p class="header-items-sub-item">Cộng đồng</p>
                </li>
              </nuxt-link>
              <nuxt-link to="/news/announcements">
                <li class="header-items-sub-items">
                  <p class="header-items-sub-item">Riot games</p>
                </li>
              </nuxt-link>
            </ul>
          </li>
          <nuxt-link to="https://lolesports.com/schedule" target="_blank">
            <li class="header-items-item-container items-link">
              <div class="item-name-link-container flex">
                <p class="header-items-name-link">Esports</p>
                <div><IconsNavigate /></div>
              </div>
              <div class="item-hover-bottom-border"></div>
            </li>
          </nuxt-link>
          ...
          <nuxt-link
            to="https://lienminh.vnggames.com/ho-tro-khach-hang/"
            target="_blank"
          >
            <li class="header-items-item-container items-link">
              <div class="item-name-link-container flex">
                <p class="header-items-name-link">Hỗ trợ</p>
                <div><IconsNavigate /></div>
              </div>
              <div class="item-hover-bottom-border"></div>
            </li>
          ...
          <nuxt-link
            to="https://leaguelink.riotgames.com/vi-vn/?utm_source=Mainsite"
            target="_blank"
          >
            <li class="header-items-item-container items-link">
              <div class="item-name-link-container flex">
                <p class="header-items-name-link">Liên kết tài khoản</p>
                <div><IconsNavigate /></div>
              </div>
              <div class="item-hover-bottom-border"></div>
            </li>
      ...
      <div class="header-items-right">
        <ul class="header-items-right-container flex">
          <li class="header-items-item-container">
            <nuxt-link to="/register">
              <button class="header-btn-play">Chơi ngay</button>
            </nuxt-link>
          </li>
        </ul>
      </div>
      <div class="header-menu-mobile-container" @click="handleShowMenu">
        <svg class="" viewBox="0 0 48 48">
      ...
      <div
        class="header-menu-options-container"
        :class="{ 'is-show': showMenuMobile }"
      >
        <div class="header-menu">
          <div class="header-menu-icon-container">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="league"
              width="85"
          ...
          <div
            class="header-menu-icon-close-container"
        ...
        <ul class="header-menu-options">
          <li
            class="header-menu-items"
            @click="handleRouterPush('/how-to-play')"
          >
            <span>Trò Chơi</span>
          </li>
          <li class="header-menu-items flex" @click="toggleSubmenu">
            <span>tin tức</span>
            <div
              class="arrow-icon-container"
              data-v-inspector="components/Header/Header.vue:105:15"
              data-v-5ada1ca4=""
            >
              <svg
                class=""
                ...
                width="15"
                height="15"
                data-v-inspector="components/Icons/ArrowDown.vue:2:3"
                data-v-5ada1ca4=""
              >
                <path
                  fill="#737373"
                  d="M.707 1.707l2.586 2.586a1 1 0 001.414 0l2.586-2.586C7.923 1.077 7.477 0 6.586 0H1.414C.524 0 .077 1.077.707 1.707z"
                  data-v-inspector="components/Icons/ArrowDown.vue:3:5"
                ></path>
              </svg>
            </div>
          </li>
          <ul class="sub-menu-mobile-container" v-if="isSubmenu">
            <li
              class="sub-menu-mobile-items-container"
              @click="handleRouterPush('/news')"
            >
              <span>tất cả</span>
            </li>
            <li
              class="sub-menu-mobile-items-container"
              @click="handleRouterPush('/news/game-updates')"
            >
              <span>cập nhật trò chơi</span>
            </li>
            <li
              class="sub-menu-mobile-items-container"
              @click="handleRouterPush('/news/esports')"
            >
              <span>esports</span>
            </li>
            <li
              class="sub-menu-mobile-items-container"
              @click="handleRouterPush('/news/dev')"
            >
              <span>đội ngũ phát triển</span>
            </li>
            <li
              class="sub-menu-mobile-items-container"
              @click="handleRouterPush('/news/media')"
            >
              <span>truyền thông</span>
            </li>
            <li
              class="sub-menu-mobile-items-container"
              @click="handleRouterPush('/news/community')"
            >
              <span>cộng đồng</span>
            </li>
            <li
              class="sub-menu-mobile-items-container"
              @click="handleRouterPush('/news/riot-games')"
            >
              <span>riot games</span>
            </li>
          </ul>
          <nuxt-link to="https://lolesports.com/schedule">
            <li class="header-menu-items">
              <span>esports</span>
            </li>
          </nuxt-link>
          <nuxt-link to="https://lienminh.vnggames.com/ho-tro-khach-hang/">
            <li class="header-menu-items">
              <span>hỗ trợ</span>
            </li></nuxt-link
          >
        ...
        <nuxt-link to="/register" class="mobile-play-btn">
          <span>Chơi ngay</span>
        </nuxt-link>
      </div>
    </div>
