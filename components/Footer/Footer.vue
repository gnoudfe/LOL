<template>
  <div>
    ...
    <div class="footer-wrapper">
      <div class="footer-icon-social-logo-wrapper">
        <nuxt-link
          to="https://www.facebook.com/Leagueoflegendsvn/"
          target="_blank"
        >
          <div class="footer-icon-social-logo">
        ...
        <nuxt-link to="https://www.instagram.com/lmhtvietnam/" target="_blank">
          <div class="footer-icon-social-logo">
      ...
      <div class="footer-icon-partner-logo-wrapper">
        <div class="footer-icon-partner-logo">
          <svg class="" viewBox="0 0 587.93 165">
        ...
        <div class="footer-icon-partner-logo">
          <img src="/img/vng-logo.png" alt="vng logo" />
        </div>
      </div>
      <div class="footer-company-intro-wrapper">
        <p>
          © 2009-2022 bởi Tập Đoàn Riot Games. LIÊN MINH HUYỀN THOẠI và mọi logo
          liên quan là nhãn hiệu, nhãn hiệu dịch vụ và/hoặc nhãn hiệu đã đăng ký
          của Tập Đoàn Riot Games.
        </p>
      </div>
      <div class="footer-legacy-navigation-wrapper">
        <nuxt-link to="https://id.zing.vn/v2/policy/privacy" target="_blank">
          <div class="footer-legacy-items">
            <p>CHÍNH SÁCH BẢO MẬT</p>
          </div>
        </nuxt-link>

        <nuxt-link
          to="https://lienminh.vnggames.com/thoa-thuan-nguoi-dung/"
          target="_blank"
        >
          <div class="footer-legacy-items">
            <p>ĐIỀU KHOẢN SỬ DỤNG (RIOT)</p>
          </div>
        </nuxt-link>
      </div>
      <div class="footer-img-warn-wrapper">
        <div class="footer-img-container">
          <img src="/img/vn-18plus.png" alt="vng warning img" />
        </div>
      </div>
    </div>
  </div>
