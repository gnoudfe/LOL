<template>
  <div
    class="champion-type-logo-svg"
    :class="{ 'current-champ': currentChamp }"
  >
    <svg
      v-if="props.championType === 'SÁT THỦ'"
    ...
    <svg v-if="props.championType === 'ĐẤU SĨ'" viewBox="0 0 100 100">
      <path
    ...
    <svg v-if="props.championType === 'PHÁP SƯ'" viewBox="0 0 100 100">
      <path
    ...
    <svg v-if="props.championType === 'XẠ THỦ'" viewBox="0 0 100 100">
    ...
    <svg v-if="props.championType === 'HỖ TRỢ'" viewBox="0 0 100 100">
      <path
    ...
    <svg v-if="props.championType === 'ĐỠ ĐÒN'" viewBox="0 0 100 100">
      <path
